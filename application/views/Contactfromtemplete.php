<style>
     tbody{
     background-image:url("http://www.washbox.thewashbox.in/application/assests/images/final/REMOTE-CONTROL_03.png
")
     }
</style>
...
<img src="http://www.washbox.thewashbox.in/application/assests/images/logo-final.png" class="img" border="0" alt="Washbox" style="margin:0px;padding:0px 231px;display:block;width: 20%;height: 100px"/>
</a>
</td>
</tr>
</tbody>
...
<h2 style="font-size:22px;font-weight:bold;color:#666666;font-family:'Myriad Pro','Arial',sans-serif;font-weight:300">
                          ...
                          Welcome <?php echo $data["firstname"]; ?>,
...
We will look over your message and get back to you soon. In the meantime, you can check the FAQ section , we shall Pick up, Wash, Iron and Deliver your clothes, all with utmost care.
 Your Telephone number:<?php echo $data["telephone"];?>
 </td>
</tr>
<tr>
<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:'Myriad Pro','Arial',sans-serif;font-weight:300;font-weight:2">
