...
<section id="content"   style="background: #E0E0E0;width: 100% !important"  ng-app="washbox" ng-controller="WashBoxController">
        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 bhoechie-tab"  style="background-color: white;">
          ...
          <div  class="bhoechie-tab-content <?php echo $profile; ?>"  id="profileDisplay">
            ...
            <form name="profileForm" class="profile" ng-submit="profileUpdate()" ng-hide="profileDisplay" role="form" method="post" name="profile" novalidate >
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <label>Last Name:</label>
                  <input type="text" class="form-control input-sm " placeholder="Last Name" ng-model="lastName" >
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                <button type="submit" class="button orange button-rounded" >
          ...
          <div  class="bhoechie-tab-content <?php echo $address; ?>" id="addressDisplay">
            ...
            <form class="" ng-submit="addressForm()" role="form" method="post" id="addressAction" ng-hide="addressAction" name="addressvalidation">
               ...
               <div style="margin-top:10px">
                    <div class="col-md-3 no-padding">
                          <div class="col-md-2 no-padding">
                            <input type="radio" ng-model="address.type" name="address.type" value="Office" style="display: block;" class="required" ng-required="true">
                          </div>
                          <div class="col-md-6">
                            <label>Office</label>  
                          </div>
                        ...
                        <div class="col-md-3 no-padding">
                          <div class="col-md-2">
                            <input type="radio" ng-model="address.type" name="address.type" value="Home" style="display: block;" class="required" ng-required="true">
                          </div>
                          <div class="col-md-6">
                            <label>
                              Home
                        ...
                        <div class="col-md-3 no-padding">
                          <div class="col-md-2">
                            <input type="radio" class="required" ng-required="true" ng-model="address.type" name="address.type" value="Other" style="display: block;">
                          </div>
                          <div class="col-md-6">
                            <label>
                              Other
              ...
              <div class="col_half">
              <label for="billing-form-name">Door No</label>
              <input id="doorNo" placeholder="Enter Your Door No" ng-model="doorno" class="required input-sm  form-control input-block-level" type="text" value="" name="doorno" ng-required="true">
                <span style="color:#DD4F3E" ng-show="addressvalidation.doorno.$dirty && addressvalidation.doorno.$invalid">
                    <span ng-show="addressvalidation.doorno.$error.required">Door No is required.</span>
                  </span>
              </div>
              <div class="col_half">
              <label for="billing-form-name">Address:</label>
              <textarea rows ="1" onFocus="geolocate()" id="address" placeholder="Enter Your Address" ng-model="street_name1" class="required form-control input-block-level" type="text" value="" name="street_name1" ng-required="true"></textarea>
               <span style="color:#DD4F3E" ng-show="addressvalidation.street_name1.$dirty && addressvalidation.street_name1.$invalid">
                    <span ng-show="addressvalidation.street_name1.$error.required">Address Name is required.</span>
                  </span>
              </div>
       <!--       <div class="col_half">
             ...
             <!-- <div class="col_half hide">
              ...
              <div class="col_half">
              <label for="billing-form-name">City:</label>
              <input id="city" placeholder="Enter Your City" ng-model="city" class="required input-sm  form-control input-block-level" type="text" value="" name="city" ng-required="true" value="Bangalore">
              ...
              <div class="col_half">
                <!--{{address.type}}-->
              <button type="submit" class="button orange button-rounded address" id="continue" ng-disabled="addressvalidation.city.$dirty && addressvalidation.city.$invalid || addressvalidation.area.$dirty && addressvalidation.area.$invalid || addressvalidation.landmark.$dirty && addressvalidation.landmark.$invalid || addressvalidation.street_name1.$dirty && addressvalidation.street_name1.$invalid || addressvalidation.address_type.$dirty && addressvalidation.address_type.$invalid || addressvalidation.doorno.$dirty && addressvalidation.doorno.$invalid && address.type">Save & continue</button>
              </div>
            </form>                   
          </div> 
          <!-- PlaceOrder  -->
...
<!--                    <div class="btn-group col-md-4 col-xs-12 no-padding" ng-repeat="washtype in serviceType">
                    ...
                    <div class="btn-group col-md-4 col-xs-12 no-padding">
                      <input type="checkbox" ng-change="serviceChange()" id="Wash & Iron" data-value="WASH" data-DESC="Washing" value="2" ng-model="serviceType.wash_iron" class="washType"/>
                      <label class="btn-washtype" for="Wash & Iron">Washing</label>
                    </div>
                    <div class="btn-group col-md-4 col-xs-12 no-padding">
                      <input  id="Dry Cleaning" value="3"  ng-change="serviceChange()" ng-model="serviceType.dry" data-value="DRY" data-desc="Dry Cleaning" class="washType" type="checkbox"/>
                      <label class="btn-washtype" for="Dry Cleaning">Dry Cleaning</label>
                    </div>
                    <div class="btn-group col-md-4 col-xs-12 no-padding"  >
                      <input id="Iron"  value="2"  ng-change="serviceChange()" ng-model="serviceType.iron" data-value="IRON" data-desc="Iron" class="washType" type="checkbox"/>
                ...
                <div class="col-md-6 pickup-mobile">
                  ...
                  <div class="col-md-12 truck-body" >
                    <span class="truck_collection trucks"> </span><font color="#25A7FD"> Collection </font> Please choose a collection date</div>
                ...
                <div class="col-md-6 delivery-mobile">
                    ...
                    <div class="col-md-12 truck-body">
                      <span class="truck_delivery trucks"> </span><font color="#8AC03F"> Delivery </font>Please choose a delivery date</div>
          ...
          <!--Confirm Order Tab-->
           <div class="bhoechie-tab-content" id="confirmOrderDisplay">
            ...
            <div class="table-responsive">
                   ...
                   <tr>
                    ...
                    <td>
                      ...
                      <tr class="cart_item">
                              ...
                              <td class="cart-product-name">
                                      <p ng-if="deliveryNotes">{{deliveryNotes}}</p>
                                      <p ng-if="!deliveryNotes">No Instructions</p>
                              </td>
                      </tr>
                      <tr class="cart_item">
                              <td class="cart-product-name">
                              ...
                              <td class="cart-product-name">
                                       <p>{{collectionDate}} <span style="padding:3%">{{pickup}}</span></p>
                              </td>
                      </tr>
                     <!-- <tr class="cart_item">
                              <td class="cart-product-name">
                      ...
                      <tr class="cart_item">
                              ...
                              <td class="cart-product-name">
                                      <strong>Delivery Date and Time</strong>
                              </td>

                              <td class="cart-product-name">
                                       <p>{{deldate}}<span style="padding:3%">{{deltime}}</span></p>
                              </td>
                      </tr>
                      <!--<tr class="cart_item">
                ...
                <div class="col-md-12" style="padding: 0px 0px 0 16px;">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-xs-12">
                ...
                <div class="col-md-12" style="padding: 28px 0px 0 16px;">
                  <input type="checkbox" id="termsconditions"  ng-required="true"> I agree with <a href="<?php echo site_url();?>WashBox/termsconditions">Terms & Conditions</a> of <b>THEWASHBOX</b>.
                </div>
...
<script>
  ...
  function serviceDuraiton()
  {
    ...
    {
      return parseInt(Math.max.apply(Math, maxArray));
    }
    else
    {
        return 0;
  ...
  $scope.addressForm = function ()
  {
    ...
    var street_name1=$('#doorNo').val()+"-"+$('[name="street_name1"]').val();
    ...
    $http({
      ...
      method: "POST",
      data: {id:id,street_name1:street_name1,area:area,city:city,address_type:address_type,landmark:landmark},
      }).success(function(data, status, headers, config){
      if (data != "")
      {
    ...
    $http({
      ...
      }).success(function(data, status, headers, config)
      {
       if (data != ""){
        $scope.addressLooping = false;
        $scope.addressAction = true;
        $scope.doorno=data[0].street_name1.split('-')[0];
        $scope.address_type=data[0].address_type;
        $scope.landmark=data[0].landmark;
        $scope.street_name1=data[0].street_name1.split('-')[1];
  ...
  $scope.getPickupTiming=function($date)
  {
    $http({
      ...
      if (countForwash==0) {
        $('.sub.active:first').trigger('click')
        countForwash++
      }
      if(data.shift=="yes"){
        pickupNext();
...
<script>
  ...
  function forTomorrow(){
    var firstDate=new Date("<?php date_default_timezone_set('Asia/Kolkata');echo date('m/d/Y');?>");
    var firstChild=$(".pickup").find(".sub :first-child");
      $(".pickup .sub:first-child").each(function(){
  ...
  function pickup()
  {
    ...
    var pickUpFullDate=new Date("<?php date_default_timezone_set('Asia/Kolkata');echo date('m/d/Y');?>");
    var activeClass;
    $(".pickup").html(" ");
  ...
  function delivery(deliveryValue,$this)
  {
    ...
    var bufferDate=parseInt(deliveryArray[0])+parseInt(serviceDuraiton());
    var delivery=new Date(deliveryArray[1]+"/"+bufferDate+"/"+deliveryArray[2]);
