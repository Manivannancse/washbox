  ...
  <div class="widget">
   ...
   <div class="widget-body col-lg-12 " style="padding:44px 0 ">
    <div class="col-md-6 col-xs-12 ">
     ...
     <div class="col-md-7 form-group paddingTop" id="printContent"><img id="barcode" style="" > <?php barcode( "order-".$order[0]["order_id"],"#barcode");?>  </div>
    </div>
     ...
     <table class="table table-hover table-striped table-bordered">
      ...
      <tbody>
       ...
       <tr class="PICKUPCHARGE ">
         <td class="removeBorder" colspan="4"></td>
         <td>Pickup charge </td>
         <td id="PICKUPCHARGE"><?php echo $order[0]["pickup"] ?></td>
        </tr>
       <tr class="SERVICE-TAX ">
         <td class="removeBorder" colspan="4"></td>
         <td>ServiceTax</td>
         <td id="SERVICE-TAX"><?php echo $order[0]["servicetax"] ?></td>
        </tr>
