            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                          ...
                          <div class="widget-body">
                            <div id="fromUpdate">
                                <form role="form" >
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter your email" id="email"  class="form-control" value="">
                                         
                                    </div>
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">PhoneNumber</label>
                                        <input type="text" placeholder="Enter your mobile umber" id="phonenumber"  class="form-control" value="">
                                         
                                    </div>
                                       <div class="form-group">
                                         <label for="exampleInputEmail1">OfficeRole</label>
                           ...
                           <select name="employer" class="form-control" id="employe" ng-model="employe">
