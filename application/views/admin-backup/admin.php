            ...
            <div class="widget-body">
                <div>
                    <form role="form" ng-submit="adminUserForm()" >
                        ...
                        <div class="form-group col-md-3">
                            <label for="exampleInputPassword1">EmployeRole</label>
                           <select name="employe" class="form-control" ng-model="employe">
                                <option disabled selected value="">Select a Role</option>
                                <option value="PickUp">Pickup</option>
                                <option value="Deilvery">Delivery</option>
...
<script>
    ...
    function adminController($scope, $http) {
        ...
        $scope.adminUserForm = function ()
        {
            ...
            $.ajax({
                ...
                type: "post",
                data:{name:name,role:role,password:password,email:email,phonenumber:phonenumber,employe:employe},
                success:function(result){
                        getAdminUser();
                    $("#dataRespTable_filter").find("input").addClass("form-control");
                }
  ...
  function updateForm(){
   ...
   var dataString = "&id=" + id  +  "&name=" + name + "&password=" + password + "&role=" + role + "$employe" + employe + "$email" +email + "$phonenumber"+phonenumber;
   $.ajax({  
    type: "POST",  
