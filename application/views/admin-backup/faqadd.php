                ...
                <div>
                    <form role="form" ng-submit="getfaqfrom()" >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" placeholder="faqttitle" id="" ng-model="faqt" class="form-control">
				
                        </div>
			<div class="form-group col-md-6">
                            <label for="exampleInputEmail1">FAQ SUBTITLE</label>
                            <input type="text" placeholder="faqttitle" id="" ng-model="faqs" class="form-control">
				
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">FAQ DESC </label>
                           <input type="text" placeholder="faqdesc" id="" ng-model="faqd" class="form-control">
                            ...
                            <div id="fromUpdate">
                                <form role="form" >
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">FAQ TITLE</label>
                                        <input type="text" placeholder="100Price" id="faqt"  class="form-control" value="">
                                         
                                    </div>
				     <div class="form-group">
                                        <label for="exampleInputEmail1">FAQ SUBTITLE</label>
                                        <input type="text" placeholder="100Price" id="faqs"  class="form-control" value="">
                                         
                                    </div>
                                    
                                     <div class="form-group">
                                        <label for="exampleInputEmail1">FAQ DESC</label>
                                        <input type="text" placeholder="100start" id="faqd"  class="form-control" value="">
...
<script>
	...
	//alert();
	    ...
	    var faqs=$scope.faqs;
             ...
             $.ajax({
                ...
                type: "post",
                data:{faqt:faqt,faqd:faqd,faqs:faqs},
                success:function(result){
                        getfaqlist();
                    $("#dataRespTable_filter").find("input").addClass("form-control");
                }
  ...
  function updateForm(){
   ...
   $.ajax({  
    ...
    data: {id:id,faqt:faqt,faqd:faqd,faqs:faqs},
