            ...
            <table class="table table-hover table-striped table-bordered">
                 ...
                 <tbody>
                     ...
                     <tr class="PICKUPCHARGE ">
                      ...
                      <td>Pickup Amount</td>
                      <td id="PICKUPCHARGE">
                       <input type="text" class="form-control gokul  PICKUP-FIELD" id="pic" placeholder="Enter pickup charge">
                      </td>
                     </tr>
                      <tr class="SERVICE">
                      <td colspan="5"></td>
                      <td>ServiceTax Amount</td>
                      <td id="SERVICE-TAX"><input type="text" onkeyup="$('#TOTAL-FINAL-AMOUNT').text(parseFloat($('#TOTAL-AMOUNT').text())+parseFloat(this.value))"class="form-control gokul SERVICE-TAX" id="ser" placeholder="Enter servicetax"></td>
                     </tr>
...
<script>
 ...
 if (fullAmount>0) {
  ...
  fullAmount=parseFloat(fullAmount)+parseFloat(pickup);
  pickup=parseFloat(fullAmount)+parseFloat(servicetax);
