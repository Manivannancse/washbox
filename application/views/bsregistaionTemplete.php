...
<img src="http://www.washbox.thewashbox.in/application/assests/images/logo-final.png" class="CToWUd" border="0" alt="Washbox" style="margin:0px;padding:0px231px;display:block;width: 20%;height: 330px"/>
</a>
</td>
</tr>
</tbody>
...
Hai Admin..!Mail from  BusinessService Filled Form!<?php echo $data["your-enquiry"]; ?>

ClientName:<?php echo $data["first_name"]; ?><br>
Telephone Number:<?php echo $data["your-telephone"];?><br>
Enquiry:<?php echo $data["your-enquiry"];?><br>
Message:<?php echo $data["message"];?><br>
ClientEmail:<?php echo $data["your-email"];?><br>
 
 Hai Washbox <?php echo $data["first_name"]; ?> having query for the businessService side message!!!!!!!! 
...
<small>© Washbox Technologies Pvt Limited, Bangalore</small>
<span class="HOEnZb">
<font color="#888888"> </font>
</span>
</td>
