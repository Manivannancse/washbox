...
select {
    ...
    <div class="section opencontent">
        <div class="container move fadeInUp">
            <p style="text-align: center;">Laundry is a lot more time consuming than you may think. Studies show we each spend an average of ten hours per month on sorting, washing and ironing. Think of everything else you could do with that time!</p>
            <p style="text-align: center;">If you offer your employees a regular laundry service then you remove a tiresome chore, give them more free time and ensure a well-presented workforce all at once. It's a win-win and it's available 7am to 10pm, 7 days a week.</p>
            <p style="text-align: center;">Want to discuss how theWashBox can help your business? Simply, fill the form below or to work with us directly click here.</p>
        </div>
    </div>
    <div class="section formblock">
        <div class="container move fadeInUp">
            ...
            <hr>
            <h4>Set up benefits for your staff</h4>
            <div role="form" class="wpcf7" id="wpcf7-f14495-o2" lang="en-US" dir="ltr">
			    ...
			    <option value="Airbnb">Hospitality</option><option value="Dry Cleaners">Dry Cleaners</option><option value="Residential">Residential</option></select></span>
                        </div>
