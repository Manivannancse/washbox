...
<td valign="top">
<a href="">
<img src="http://www.washbox.thewashbox.in/application/assests/images/logo-final.png"  class="CToWUd" border="0" alt="Washbox" style="margin:0px 231px;padding:0px;display:block;width: 20%"/>
</a>
</td>
</tr>
</tbody>
</table>
<table width="581" cellspacing="0" cellpadding="0" border="0" bgcolor="#87CEFA" align="center" style="border-bottom:1px solid #e1e1e1;margin-bottom:30px">
<tbody>
<tr>
...
<h2 style="font-size:22px;font-weight:bold;color:#666666;font-family:'Myriad Pro','Arial',sans-serif;font-weight:300">
                          ...
                          Welcome To Washbox<?php echo $OrderDetails["first_name"]; ?>,
                    
</td>
</tr>
<tr>
<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:'Myriad Pro','Arial',sans-serif;font-weight:300;font-weight:2px"> 

Thanks for your Service!
your orderis place successfully<?php echo $OrderDetails["order_id"]; ?> 
We pickup the order soon . we shall Pick up, Wash, Iron and Deliver your clothes, all with Custmore care.thanking You for ur best service.
...
<small>© Washbox  Pvt Ltd, Bangalore</small>
<span class="HOEnZb">
<font color="#888888"> </font>
</span>
</td>
