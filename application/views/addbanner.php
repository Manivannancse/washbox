    ...
    <div class="col-lg-12 col-sm-12 col-xs-12 hide"  id="addItem">
        <div class="widget">
			...
			<div class="form-group col-md-6">
			 ...
			 <div class="form-group col-md-6">
                            <label for="exampleInputPassword1">BANNER FONT TEXT</label>
			 ...
			 <div class="form-group col-md-6">
                            <label for="exampleInputPassword1">BANNER COLOR TEXT</label>
			 ...
			 <div class="form-group col-md-6">
                            <label for="exampleInputPassword1">BANNER SIZE TEXT</label>
