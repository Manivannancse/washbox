...
<div class="row modal-spacing">
    ...
    <div class="col-md-6 col-xs-6">
        ...
        <div class="col-md-6 form-group"><i class="fa fa-17 fa-gears"></i> &nbsp; <?php echo $order[0]["clean_type"] ?></div>
         <div class="col-md-6 form-group"><b>Coupen</b></div>
         <div class="col-md-6 form-group">
            <span class="input-icon">
                <input type="text" id="coupen" value="<?php echo $order[0]["token_id"] ?>" class="form-control">
    ...
    <div class="col-md-12 ">
        ...
        <div class="form-group col-md-4 col-md-offset-4 modal-spacing">
            <select ng-model="role" class="form-control ng-pristine ng-valid" id="assignEmployee">
                <option disabled="" value="Select a Role">Select a employee</option>
                <?php
                    foreach($admin as $user)
                    {
                ?>
                    <option value="<?php echo $user['id']?>" <?php if($order[0]["assigned_to"]==$user['id']) echo "selected=\"selected\"";?>><?php echo $user['name'];?></option>
                <?php
                    }
                ?>
            </select>
