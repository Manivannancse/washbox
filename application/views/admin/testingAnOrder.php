            ...
            <table class="table table-hover table-striped table-bordered">
                 ...
                 <tbody>
                     ...
                     <tr class="DISCOUNT">
                      ...
                      <td id="TOTAL-DISCOUNT">
                       <input type="text" onkeyup="$('#TOTAL-FINAL-AMOUNT').text(parseFloat($('#TOTAL-AMOUNT').text())-parseFloat(this.value))"  class="form-control gokul  DISCOUNT-FIELD" id="dis" placeholder="Enter Qunatity"></td>
                     </tr>
                     <tr class="PICKUPCHARGE ">
                      <td colspan="5"></td>
                      <td>Pickup Amount</td>
                      <td id="PICKUPCHARGE">
                       <input type="text" class="form-control gokul  PICKUP-FIELD"  onkeyup="totalAmountCal();" id="pic" placeholder="Enter pickup charge">
                      </td>
                     </tr>
                      <tr class="SERVICE">
                      <td colspan="5"></td>
                      <td>ServiceTax Amount</td>
                      <td id="SERVICE-TAX"><input type="text" onkeyup="totalAmountCal();" class="form-control  SERVICE-TAX" id="ser" placeholder="Enter servicetax"></td>
                     </tr>
                     ...
                     <script>
                      ...
                      //$('.gokul').keyup(function(){
                      //             
                      //                  
                      //var pic= parseFloat($('#pic').val());
                      // var ser= parseFloat($('#ser').val());
                      // var dis= parseFloat($('#dis').val());
                      //
                      // var tota=$('#TOTAL-FINAL-AMOUNT').text();
                      // 
                      // var restota = pic+ser+tota;
                      // //alert(restota);
                      // //var restota = tota-dis;
                      // $('#TOTAL-FINAL-AMOUNT').text(restota);
                      // 
                      //});
                     </script>
           </tbody>
...
<script>
  ...
  //var pickup=0;
  //var servicetax=0;
  var pickup=$(".PICKUP-FIELD").val();
  var servicetax=$(".SERVICE-TAX").val();
  if (servicetax=='') {
   servicetax=0;
  }
  if (pickup=='') {
 ...
 original =parseFloat(fullAmount)+parseFloat(pickup)+parseFloat(servicetax)-parseFloat(discount);
 
  
 //}
 $(".DISCOUNT-FIELD").val(discount);
 $(".PICKUP-FIELD").val(pickup);
 $(".SERVICE-TAX").val(servicetax);
 ...
 $(myHTML).appendTo("tbody");
  ...
  $('<tr class="TOTAL"><td colspan="5"></td><td>Total</td><td id="TOTAL-AMOUNT"></td></tr><tr class="DISCOUNT"><td colspan="5"></td><td>Discounted Amount </td><td id="TOTAL-DISCOUNT"><input type="text" onkeyup="totalAmountCal()"class="form-control  DISCOUNT-FIELD" id="" placeholder="Enter Qunatity"></td></tr><tr class="PICKUPCHARGE"><td colspan="5"></td><td>Pickup Amount </td><td id="PICKUPCHARGE"><input type="text" onkeyup="totalAmountCal()"class="form-control  PICKUP-FIELD" id="" placeholder="Enter the pickupcharge"></td></tr><tr class="SERVICE"><td colspan="5"></td><td>servicetax Amount</td><td id="SERVICE-TAX"><input type="text" onkeyup="totalAmountCal()"class="form-control  SERVICE-TAX" id="" placeholder="Enter the servicetax"></td></tr><tr class="FINAL-TOTAL"><td colspan="5"></td><td>Total Amount =</td><td id="TOTAL-FINAL-AMOUNT"> 0</td></tr>').appendTo("tbody");
  totalAmountCal();
 }
 ...
 var pickupAmount=$(".PICKUP-FIELD").val();
 var servicetaxAmount=$(".SERVICE-TAX").val();
 ...
 if (orderData.length>0) {
   ...
   type: "post",
   data: {orderId:orderId,originalAmount:originalAmount,discountedAmount:discountedAmount,pickupAmount:pickupAmount,servicetaxAmount:servicetaxAmount,finalAmount:finalAmount,orderData:orderData},
   success: function(result) {
