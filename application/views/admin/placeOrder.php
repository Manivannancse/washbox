...
<!--                                 <th>
                        ...
                        <tbody>
                            <?php foreach($order as $row){?>
                                <tr class="">
                                    <td><center><a onclick="selectOrder(<?php echo $row->id; ?>)" class="btn btn-danger shiny btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg" >Click here Order - #<?php echo $row->order_id; ?> </a></center></td>
     ...
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             <div class="modal-header">
                <button type="button"  ng-click="sendSMS(true)" class="close" data-dismiss="modal" aria-hidden="true">x</button>
...
<script>
    ...
    var messgeStatus ="PickUp";
    $.ajax({
      url: "<?php echo site_url();?>WashControl/updateOrderStatus",
      type: "post",
      data: {id:id,status:status,employeeId:employeeId,payAmount:payAmount,messgeStatus:messgeStatus},
      success: function(result) {
