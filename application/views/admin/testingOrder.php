                        ...
                        <tbody>
                            <?php foreach($order as $row){?>
                                <tr class="">
                                    ...
                                    <td><center><a href="<?php echo base_url('WashControl/testingAnOrder/'.$row->id);?>" class="btn btn-danger shiny btn-sm" >Click here Order - #<?php echo $row->order_id; ?> </a></center></td>
