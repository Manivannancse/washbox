        ...
        <div class="col-md-4 col-sm-6 col-xs-12" >
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <div class="row">
                      <div class="hidden-xs horizantalHrDiv"><center><img class="horizantalHr img-responsive" style="width:80%"src="<?php echo site_url();?>application/assests/assets/img/shadow2.png"></center></div>
                    </div>
                    <div class="row">                    
                        <div class="col-md-12">
...
<script type="text/javascript" src="<?php echo base_url(); ?>application/assests/assets/plugins/js/qrcodelib.js"></script>	
<script type="text/javascript" src="<?php echo base_url(); ?>application/assests/assets/plugins/js/WebCodeCam.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>application/assests/assets/plugins/js/main.js"></script>
