...
<img src="http://www.washbox.thewashbox.in/application/assests/images/logo-final.png" class="img" border="0" alt="Washbox" style="margin:0px;padding:0px;display:block;width: 20%;height: 330px"/>
...
<h2 style="font-size:22px;font-weight:bold;color:#666666;font-family:'Myriad Pro','Arial',sans-serif;font-weight:300">
                          ...
                          Welcome To Washbox<?php echo $data["first_name"]; ?>,
...
Thanks for filling out our form BusinessService!
We will look over your message and get back to you soon. In the meantime, you can check the FAQ section , we shall Pick up, Wash, Iron and Deliver your clothes, all with utmost care.
<br>Your Enquiry:<?php echo $data["nature"];?><br>Your Message:<?php echo $data["message"];?>
